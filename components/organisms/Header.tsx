...
export const Header = () => {
    return (
        <header className="flex justify-between items-center py-4 md:py-8 mb-8 md:mb-12 xl:mb-16">
            ...
            {/* <!-- button - start --> */}
            <button type="button" className="inline-flex items-center lg:hidden hover:bg-gray-300 focus-visible:ring ring-indigo-300 active:text-gray-700 text-sm md:text-base font-semibold rounded-lg gap-2 px-2.5 py-2">
